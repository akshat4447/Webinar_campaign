...
INSERT INTO "new_Campaign" ("archived", "attendance", "attendanceImportedAt", "cadenceStatus", "createdAt", "dailyLimit", "date", "demoRequests", "description", "frequency", "id", "invites", "linkedinEventError", "linkedinEventStatus", "linkedinEventUrn", "linkedinInvitedAt", "linkedinMode", "linkedinPostUrn", "linkedinRegFormUrn", "lsqListId", "name", "personalizationPrompt", "registrationLink", "registrations", "scheduleWindow", "scheduledAt", "scoringCriteria", "scoringPrompt", "scoringThreshold", "simulatedNow", "status", "updatedAt", "vertical", "zoomLink") SELECT "archived", "attendance", "attendanceImportedAt", "cadenceStatus", "createdAt", "dailyLimit", "date", "demoRequests", "description", "frequency", "id", "invites", "linkedinEventError", "linkedinEventStatus", "linkedinEventUrn", "linkedinInvitedAt", "linkedinMode", "linkedinPostUrn", "linkedinRegFormUrn", "lsqListId", "name", "personalizationPrompt", "registrationLink", "registrations", "scheduleWindow", "scheduledAt", "scoringCriteria", "scoringPrompt", "scoringThreshold", "simulatedNow", "status", "updatedAt", "vertical", "zoomLink" FROM "Campaign";
DROP TABLE "Campaign";
