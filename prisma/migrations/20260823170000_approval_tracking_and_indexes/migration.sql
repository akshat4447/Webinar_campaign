...
INSERT INTO "new_Contact" ("account", "approved", "attended", "campaignId", "createdAt", "email", "emailSimulated", "emailVerified", "enrichedAt", "enrichmentSource", "explanation", "function", "id", "linkedinId", "lsqLeadId", "missingInfo", "name", "personaNote", "score", "seniority", "source", "title", "vertical", "watchMinutes") SELECT "account", "approved", "attended", "campaignId", "createdAt", "email", "emailSimulated", "emailVerified", "enrichedAt", "enrichmentSource", "explanation", "function", "id", "linkedinId", "lsqLeadId", "missingInfo", "name", "personaNote", "score", "seniority", "source", "title", "vertical", "watchMinutes" FROM "Contact";
DROP TABLE "Contact";
