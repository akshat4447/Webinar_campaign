...
export const cadenceStepsData: CadenceStep[] = [
  ...
  { id: 'doors_open', group: 'Reminders · registrants only', title: 'Doors are opening (T-15m)', timing: 'T-15m', channel: 'WhatsApp', channelColor: 'success', desc: 'Instant WhatsApp nudge 15 minutes before webinar to maximize live show-up rate', toggleable: true },
...
export const templatesData: Template[] = [
  ...
  { id: 'doors_open', label: 'Doors are opening (T-15m)', channel: 'WhatsApp', channelColor: 'success', hasSubject: false, body: 'Hi {{firstName}}! Doors are opening now for {{topic}} live session 🚪 We are going live in 15 minutes. Join room here: {{link}}' },
