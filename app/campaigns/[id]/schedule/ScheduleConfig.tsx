    ...
    <div style={{ background: '#fff', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-card)', padding: '18px 20px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1fr)', gap: 14 }}>
        <div style={{ gridColumn: '1 / -1' }}>
          <div style={{ fontSize: 12, color: 'var(--n60)', marginBottom: 6 }}>Send window (local time) — enforced, not just a label</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            />
            <span style={{ fontSize: 12, color: 'var(--n60)' }}>to</span>
            <input
              className="lsq-input"
              type="time"
              value={end}
          ...
          <div style={{ fontSize: 11.5, color: 'var(--n50)', marginTop: 4 }}>
        ...
        <div>
          ...
          <input
            ...
            style={{ height: 38 }}
          />
          {dailyLimitError && <div style={{ fontSize: 11.5, color: 'var(--danger-500)', marginTop: 4 }}>{dailyLimitError}</div>}
        </div>
      </div>
      <div style={{ fontSize: 12, color: 'var(--n60)', marginTop: 12 }}>
