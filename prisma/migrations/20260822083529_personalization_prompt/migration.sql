...
INSERT INTO "new_Campaign" ("attendance", "attendanceImportedAt", "cadenceStatus", "createdAt", "dailyLimit", "date", "demoRequests", "description", "frequency", "id", "invites", "linkedinMode", "lsqListId", "name", "registrationLink", "registrations", "scheduleWindow", "scheduledAt", "scoringCriteria", "scoringPrompt", "scoringThreshold", "simulatedNow", "status", "updatedAt", "vertical", "zoomLink") SELECT "attendance", "attendanceImportedAt", "cadenceStatus", "createdAt", "dailyLimit", "date", "demoRequests", "description", "frequency", "id", "invites", "linkedinMode", "lsqListId", "name", "registrationLink", "registrations", "scheduleWindow", "scheduledAt", "scoringCriteria", "scoringPrompt", "scoringThreshold", "simulatedNow", "status", "updatedAt", "vertical", "zoomLink" FROM "Campaign";
DROP TABLE "Campaign";
